...
- Powered by NginX, PHP, and MariaDB...all on Alpine
- Run it locally, or modify the sensitive values and host it for your team (maybe some multi-user support could be added?)
